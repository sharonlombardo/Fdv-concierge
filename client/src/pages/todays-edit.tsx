      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <footer className="text-center py-12 border-t border-border space-y-6">
          ...
          <button
            ...
            style={{
              backgroundColor: isCapsuleSaved ? '#E24B4A' : 'transparent',
              color: isCapsuleSaved ? '#ffffff' : '#1a1a1a',
              border: isCapsuleSaved ? '1px solid #E24B4A' : '1px solid #1a1a1a',
              fontFamily: "'Inter', sans-serif",
              opacity: saveCapsuleMutation.isPending ? 0.5 : 1,
            }}
            data-testid="button-save-capsule"
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill={isCapsuleSaved ? "currentColor" : "none"} stroke="currentColor" strokeWidth={isCapsuleSaved ? 0 : 2} strokeLinecap="round" strokeLinejoin="round">
