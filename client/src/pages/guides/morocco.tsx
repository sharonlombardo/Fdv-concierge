    ...
    <div className="morocco-guide">
      ...
      <div className="place-block">
        <div className="place-images layout-b">
          <div className="img-large"><img src={`${IMG}/exp-1-large.jpg`} alt="Badi Palace" />
          </div>
      ...
      <div className="place-block reverse">
        <div className="place-images layout-c">
          ...
          <div className="img-slot"><img src={`${IMG}/exp-2-right.jpg`} alt="Jardin Secret" />
          </div>
        </div>
        <div className="place-info">
          <h3>Jardin Secret</h3>
      ...
      <div className="place-block">
        <div className="place-images layout-b">
          <div className="img-large"><img src={`${IMG}/exp-3-large.jpg`} alt="Agafay Desert Camp" />
          </div>
      ...
      <div className="place-block reverse">
        <div className="place-images layout-b">
          <div className="img-large"><img src={`${IMG}/exp-4-large.jpg`} alt="Jardin Majorelle" />
          </div>
      ...
      <div className="place-block">
        <div className="place-images layout-b">
          <div className="img-large"><img src={`${IMG}/eat-1-large.jpg`} alt="Nomad" />
          </div>
      ...
      <div className="place-block reverse">
        <div className="place-images layout-c">
          ...
          <div className="img-slot"><img src={`${IMG}/eat-2-right.jpg`} alt="Cafe Bacha" />
          </div>
        </div>
        <div className="place-info">
      ...
      <div className="place-block">
        <div className="place-images layout-b">
          <div className="img-large"><img src={`${IMG}/eat-3-large.jpg`} alt="La Famille" />
          </div>
      ...
      <div className="place-block reverse">
        <div className="place-images layout-b">
          <div className="img-large"><img src={`${IMG}/eat-4-large.jpg`} alt="Le Jardin de Lotus" />
          </div>
      ...
      <div className="place-block">
        <div className="place-images layout-c">
          ...
          <div className="img-slot"><img src={`${IMG}/eat-5-right.jpg`} alt="La Mamounia" />
          </div>
        </div>
        <div className="place-info">
      ...
      <div className="place-block reverse">
        <div className="place-images layout-b">
          <div className="img-large"><img src={`${IMG}/eat-6-large.jpg`} alt="Dar Yacout" />
          </div>
      ...
      <div className="place-block">
        <div className="place-images layout-b">
          <div className="img-large"><img src={`${IMG}/shop-1-large.jpg`} alt="The Souks" />
          </div>
      ...
      <div className="place-block reverse">
        <div className="place-images layout-c">
          ...
          <div className="img-slot"><img src={`${IMG}/shop-2-right.jpg`} alt="El Fenn Gift Shop" />
          </div>
        </div>
        <div className="place-info">
      ...
      <div className="place-block">
        <div className="place-images layout-b">
          <div className="img-large"><img src={`${IMG}/shop-3-large.jpg`} alt="Mustapha Blaoui" />
          </div>
      ...
      <div className="place-block reverse">
        <div className="place-images layout-b">
          <div className="img-large"><img src={`${IMG}/shop-4-large.jpg`} alt="Max & Jan" />
          </div>
      ...
      <div className="place-block">
        <div className="place-images layout-b">
          <div className="img-large"><img src={`${IMG}/stay-1-large.jpg`} alt="El Fenn" />
          </div>
      ...
      <div className="place-block reverse">
        <div className="place-images layout-b">
          <div className="img-large"><img src={`${IMG}/stay-2-large.jpg`} alt="Riad Jardin Secret" />
          </div>
      ...
      <div className="place-block">
        <div className="place-images layout-b">
          <div className="img-large"><img src={`${IMG}/stay-3-large.jpg`} alt="La Mamounia" />
          </div>
      ...
      <div className="place-block">
        <div className="place-images layout-b">
          <div className="img-large"><img src={`${IMG}/ward-1-large.jpg`} alt="Day in the Medina look" />
          </div>
      ...
      <div className="place-block reverse">
        <div className="place-images layout-b">
          <div className="img-large"><img src={`${IMG}/ward-2-large_fdv_isadora_dress.jpg`} alt="Riad Evenings look" />
          </div>
