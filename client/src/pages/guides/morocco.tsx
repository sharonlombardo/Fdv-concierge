    ...
    <div className="morocco-guide">
      ...
      <div className="place-block">
        <div className="place-images layout-b">
          <div className="img-large" style={{ position: "relative" }}><img src={`${IMG}/exp-1-large.jpg`} alt="Badi Palace" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-badi-palace" itemData={{ title: "Badi Palace", description: "Ruins, scale, silence.", imageUrl: `${IMG}/exp-1-large.jpg`, storyTag: "morocco", bookUrl: "http://www.badipalace.com" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "experience", "culture"]} size="sm" /></div>
          </div>
      ...
      <div className="place-block reverse">
        <div className="place-images layout-c">
          ...
          <div className="img-slot" style={{ position: "relative" }}><img src={`${IMG}/exp-2-right.jpg`} alt="Jardin Secret" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-jardin-secret" itemData={{ title: "Jardin Secret", description: "A quiet medina escape.", imageUrl: `${IMG}/exp-2-left.jpg`, storyTag: "morocco", bookUrl: "http://lejardinsecretmarrakech.com" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "experience", "garden"]} size="sm" /></div>
          </div>
        </div>
        <div className="place-info">
          <h3>Jardin Secret</h3>
      ...
      <div className="place-block">
        <div className="place-images layout-b">
          <div className="img-large" style={{ position: "relative" }}><img src={`${IMG}/exp-3-large.jpg`} alt="Agafay Desert Camp" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-agafay-desert" itemData={{ title: "Agafay Desert Camp", description: "Desert drama without the five-hour drive.", imageUrl: `${IMG}/exp-3-large.jpg`, storyTag: "morocco" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "experience", "nature"]} size="sm" /></div>
          </div>
      ...
      <div className="place-block reverse">
        <div className="place-images layout-b">
          <div className="img-large" style={{ position: "relative" }}><img src={`${IMG}/exp-4-large.jpg`} alt="Jardin Majorelle" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-jardin-majorelle" itemData={{ title: "Jardin Majorelle", description: "Cobalt blue and exquisite beauty with a side of Saint Laurent", imageUrl: `${IMG}/exp-4-large.jpg`, storyTag: "morocco", bookUrl: "http://jardinmajorelle.com" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "experience", "culture"]} size="sm" /></div>
          </div>
      ...
      <div className="place-block">
        <div className="place-images layout-b">
          <div className="img-large" style={{ position: "relative" }}><img src={`${IMG}/eat-1-large.jpg`} alt="Nomad" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-nomad" itemData={{ title: "Nomad", description: "Rooftop views and modern Moroccan.", imageUrl: `${IMG}/eat-1-large.jpg`, storyTag: "morocco", bookUrl: "http://nomadmarrakech.com" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "restaurant"]} size="sm" /></div>
          </div>
      ...
      <div className="place-block reverse">
        <div className="place-images layout-c">
          ...
          <div className="img-slot" style={{ position: "relative" }}><img src={`${IMG}/eat-2-right.jpg`} alt="Cafe Bacha" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-cafe-bacha" itemData={{ title: "Café Bacha", description: "Decadent morning ritual.", imageUrl: `${IMG}/eat-2-left.jpg`, storyTag: "morocco", bookUrl: "http://bachacoffee.com" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "restaurant", "cafe"]} size="sm" /></div>
          </div>
        </div>
        <div className="place-info">
      ...
      <div className="place-block">
        <div className="place-images layout-b">
          <div className="img-large" style={{ position: "relative" }}><img src={`${IMG}/eat-3-large.jpg`} alt="La Famille" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-la-famille" itemData={{ title: "La Famille", description: "Vegetarian and unexpectedly chic.", imageUrl: `${IMG}/eat-3-large.jpg`, storyTag: "morocco" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "restaurant"]} size="sm" /></div>
          </div>
      ...
      <div className="place-block reverse">
        <div className="place-images layout-b">
          <div className="img-large" style={{ position: "relative" }}><img src={`${IMG}/eat-4-large.jpg`} alt="Le Jardin de Lotus" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-jardin-de-lotus" itemData={{ title: "Le Jardin de Lotus", description: "Relaxed glamour", imageUrl: `${IMG}/eat-4-large.jpg`, storyTag: "morocco", bookUrl: "https://lejardindelotus.com" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "restaurant"]} size="sm" /></div>
          </div>
      ...
      <div className="place-block">
        <div className="place-images layout-c">
          ...
          <div className="img-slot" style={{ position: "relative" }}><img src={`${IMG}/eat-5-right.jpg`} alt="La Mamounia" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-mamounia-drinks" itemData={{ title: "La Mamounia — Evening Drinks", description: "Golden hour, perfected.", imageUrl: `${IMG}/eat-5-left.jpg`, storyTag: "morocco", bookUrl: "http://www.mamounia.com" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "restaurant", "bar"]} size="sm" /></div>
          </div>
        </div>
        <div className="place-info">
      ...
      <div className="place-block reverse">
        <div className="place-images layout-b">
          <div className="img-large" style={{ position: "relative" }}><img src={`${IMG}/eat-6-large.jpg`} alt="Dar Yacout" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-dar-yacout" itemData={{ title: "Dar Yacout", description: "Traditional Moroccan, done properly.", imageUrl: `${IMG}/eat-6-large.jpg`, storyTag: "morocco" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "restaurant"]} size="sm" /></div>
          </div>
      ...
      <div className="place-block">
        <div className="place-images layout-b">
          <div className="img-large" style={{ position: "relative" }}><img src={`${IMG}/shop-1-large.jpg`} alt="The Souks" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-souks" itemData={{ title: "The Souks — Of Course", description: "Start here. Then wander.", imageUrl: `${IMG}/shop-1-large.jpg`, storyTag: "morocco" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "shop", "market"]} size="sm" /></div>
          </div>
      ...
      <div className="place-block reverse">
        <div className="place-images layout-c">
          ...
          <div className="img-slot" style={{ position: "relative" }}><img src={`${IMG}/shop-2-right.jpg`} alt="El Fenn Gift Shop" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-elfenn-shop" itemData={{ title: "El Fenn Gift Shop", description: "Actually chic souvenirs.", imageUrl: `${IMG}/shop-2-left.jpg`, storyTag: "morocco", bookUrl: "http://www.elfenn.com" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "shop"]} size="sm" /></div>
          </div>
        </div>
        <div className="place-info">
      ...
      <div className="place-block">
        <div className="place-images layout-b">
          <div className="img-large" style={{ position: "relative" }}><img src={`${IMG}/shop-3-large.jpg`} alt="Mustapha Blaoui" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-mustapha-blaoui" itemData={{ title: "Mustapha Blaoui", description: "Treasure hunting at scale.", imageUrl: `${IMG}/shop-3-large.jpg`, storyTag: "morocco" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "shop"]} size="sm" /></div>
          </div>
      ...
      <div className="place-block reverse">
        <div className="place-images layout-b">
          <div className="img-large" style={{ position: "relative" }}><img src={`${IMG}/shop-4-large.jpg`} alt="Max & Jan" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-max-jan" itemData={{ title: "Max & Jan", description: "Modern Marrakech.", imageUrl: `${IMG}/shop-4-large.jpg`, storyTag: "morocco", bookUrl: "http://www.maxandjan.com" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "shop"]} size="sm" /></div>
          </div>
      ...
      <div className="place-block">
        <div className="place-images layout-b">
          <div className="img-large" style={{ position: "relative" }}><img src={`${IMG}/stay-1-large.jpg`} alt="El Fenn" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-el-fenn" itemData={{ title: "El Fenn", description: "Color, art, and rooftop sunsets.", imageUrl: `${IMG}/stay-1-large.jpg`, storyTag: "morocco", bookUrl: "http://www.elfenn.com" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "hotel", "stay"]} size="sm" /></div>
          </div>
      ...
      <div className="place-block reverse">
        <div className="place-images layout-b">
          <div className="img-large" style={{ position: "relative" }}><img src={`${IMG}/stay-2-large.jpg`} alt="Riad Jardin Secret" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-riad-jardin-secret" itemData={{ title: "Riad Jardin Secret", description: "Intimate, traditional, serene.", imageUrl: `${IMG}/stay-2-large.jpg`, storyTag: "morocco", bookUrl: "http://www.riad-jardinsecret.com" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "hotel", "stay"]} size="sm" /></div>
          </div>
      ...
      <div className="place-block">
        <div className="place-images layout-b">
          <div className="img-large" style={{ position: "relative" }}><img src={`${IMG}/stay-3-large.jpg`} alt="La Mamounia" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-la-mamounia" itemData={{ title: "La Mamounia", description: "Iconic. Unapologetically grand.", imageUrl: `${IMG}/stay-3-large.jpg`, storyTag: "morocco", bookUrl: "http://mamounia.com" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "hotel", "stay"]} size="sm" /></div>
          </div>
      ...
      <div className="place-block">
        <div className="place-images layout-b">
          <div className="img-large" style={{ position: "relative" }}><img src={`${IMG}/ward-1-large.jpg`} alt="Day in the Medina look" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-day-look" itemData={{ title: "Day in the Medina", description: "Medina uniform.", imageUrl: `${IMG}/ward-day-large.jpg`, storyTag: "morocco" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "style"]} size="sm" /></div>
          </div>
      ...
      <div className="place-block reverse">
        <div className="place-images layout-b">
          <div className="img-large" style={{ position: "relative" }}><img src={`${IMG}/ward-2-large_fdv_isadora_dress.jpg`} alt="Riad Evenings look" />
            <div style={{ position: "absolute", top: 8, right: 8, zIndex: 10 }}><PinButton itemType="place" itemId="guide-morocco-evening-look" itemData={{ title: "Riad Evenings", description: "Marrakech does drama. You might as well participate.", imageUrl: `${IMG}/ward-eve-large.jpg`, storyTag: "morocco" }} sourceContext="morocco-guide" aestheticTags={["morocco", "travel", "style"]} size="sm" /></div>
          </div>
