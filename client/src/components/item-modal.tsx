        ...
        >
          ...
          <div className="relative flex-shrink-0">
            ...
            <DialogPrimitive.Close
              className="absolute top-2 right-3 z-[60] w-11 h-11 flex items-center justify-center rounded-full bg-black/25 hover:bg-black/40 active:bg-black/50 transition-colors"
              aria-label="Close"
            >
          ...
          <div className="flex-1 overflow-y-auto min-h-0">
            ...
            <div className="px-6 pb-28 pt-5 space-y-4">
              ...
              {fromSuitcase ? (
                ...
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill={isSaved ? "currentColor" : "none"} stroke="currentColor" strokeWidth={isSaved ? 0 : 2} strokeLinecap="round" strokeLinejoin="round">
