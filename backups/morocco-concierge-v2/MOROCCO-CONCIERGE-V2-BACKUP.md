# Morocco Concierge V2 - Complete Backup
## January 13, 2026

This backup contains the Morocco 2026 concierge experience with:
- Hero section with OVERVIEW and DAILY FLOW navigation buttons
- Editorial scroll with day-by-day narrative
- Pin/Suitcase buttons on trip cards
- My Trips tab in Suitcase
- Dual-category filtering (trips appear in both My Trips and Travel/Destinations)

---

## Key Routes
- `/concierge` - Morocco editorial experience (uses home.tsx)
- `/editorial` - Standalone editorial page
- `/suitcase` - Suitcase with My Trips tab
- `/packing` - Packing list

---

## File: client/src/components/editorial-sections.tsx
...
## Section IDs in home.tsx (for scroll navigation)

The following IDs are used for the OVERVIEW and DAILY FLOW buttons:
...
- OVERVIEW button scrolls to `#editorial-overview` (just after hero)
- DAILY FLOW button scrolls to `#daily-flow` (detailed itinerary section)
- Buttons styled as minimal text links with `|` divider

### Trip Cards in Suitcase
- Trip itemType="trip" maps to my-trips category
- Trips appear in both "My Trips" AND "Travel/Destinations" tabs
- Clicking a trip card navigates to /concierge

### Route Structure
- `/concierge` uses `home.tsx` (imported as Concierge in App.tsx)
- `/editorial` uses `editorial.tsx` (standalone version)

---

## Backup Created
Date: January 13, 2026
Git Commit: 7b9e08739cc37d71f918d2238c34c68ac973e3d6
